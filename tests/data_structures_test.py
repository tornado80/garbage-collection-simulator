...
class GeneralListTest(unittest.TestCase):
    ...
    def test_garbage_collection(self):
        memory = Memory(90)
        list1 = GeneralList.convert_expression_to_general_list(memory, "(a(b(c)d)e(AB(((F)E(H))C(D)))f(g)((i)h))")
        memory.garbage_collect(list1)
        node, _ = list1.find_node_by_expression("(***(***")
        list2 = GeneralList.convert_expression_to_general_list(memory, "((MN(P))Q(R)(ST(U)))")
